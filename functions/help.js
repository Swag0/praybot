    ...
    function swapPage(page, message) {
        if (page == 0) { //Main Help
            ...
            const helpEmbed = new Discord.MessageEmbed()
                ...
                .addField("Building Everything", 'Use *†build all* to build all possible buildings in order of cost.')
            ...
            const helpEmbed = new Discord.MessageEmbed()
                ...
                .addField("Profile", 'Use *†p* to show your possessions and your item.')
                .addField("Karma", 'Use *†karma* to show your karma.')
                .addField("Leaderboard Lists", 'Use *†leaderboards* to show all leaderboards.')
                .addField("Specific Leaderboard", 'Use *†leaderboard* [type] to return the top 5 users with a specified type.')
